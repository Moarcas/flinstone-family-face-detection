...
def show_detections_without_ground_truth(detections, scores, file_names, params: Parameters):
    ...
    """
    #test_images_path = os.path.join(params.validation_dir, '*.jpg')
    test_images_path = os.path.join(params.base_dir, 'barney/*.jpg')
...
def show_detections_with_ground_truth(detections, scores, file_names, params: Parameters):
    ...
    ground_truth_bboxes = np.loadtxt(params.validation_dir + '/task1_gt_validare.txt', dtype='str')
    test_images_path = os.path.join(params.validation_dir, 'validare/*.jpg')
